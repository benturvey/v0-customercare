    ...
    <div className="container mx-auto px-4 py-6">
      ...
      <div className="grid grid-cols-3 gap-4 mb-6">
        ...
        <div>
          ...
          <div className="rounded-lg border border-blue-200 p-4" style={{ backgroundColor: "#3bc693" }}>
        ...
        <div>
          ...
          <div className="rounded-lg border border-yellow-200 p-4" style={{ backgroundColor: "#92dfc3" }}>
