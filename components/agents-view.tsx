...
const initialAgents: Agent[] = [
  ...
  },
  {
    ...
    primaryFunction: "Back Office - Collections & Claims",
    role: "BKO",
    skillLevel: "L2",
    status: "active",
    currentTickets: 0,
  ...
  },
  {
    ...
    primaryFunction: "Back Office - Collections & Exceptions",
    role: "BKO",
    skillLevel: "L2",
    status: "active",
    currentTickets: 0,
  ...
  },
  {
    ...
    primaryFunction: "Call Handler & Queries",
    role: "CHA",
    skillLevel: "L1",
    status: "active",
    currentTickets: 0,
  ...
  },
  {
    ...
    primaryFunction: "Queries & Collections",
    role: "TRK",
    skillLevel: "L2",
    status: "active",
    currentTickets: 0,
  ...
  },
  {
    id: "13",
    name: "Gina McGuiness",
    email: "gina.mcguiness@gfsdeliver.com",
    primaryFunction: "Team Leader",
    role: "agent",
    skillLevel: "L2",
    status: "active",
  ...
  },
  {
    id: "15",
    name: "John Bolton",
    email: "john.bolton@gfsdeliver.com",
    primaryFunction: "Queries",
    role: "agent",
    skillLevel: "L2",
    status: "active",
  ...
  },
  {
    ...
    primaryFunction: "Back Office - Claims & Queries",
    role: "agent",
    skillLevel: "L2",
    status: "active",
    currentTickets: 0,
  ...
  },
  {
    ...
    primaryFunction: "Senior : Queries",
    role: "agent",
    skillLevel: "L4",
    status: "active",
    currentTickets: 0,
  ...
  },
  {
    id: "22",
    name: "Mitzy Cardozo",
    email: "mitzy.cardozo@gfsdeliver.com",
    primaryFunction: "Team Leader",
    role: "ADM",
    skillLevel: "L2",
    status: "active",
  ...
  },
  {
    ...
    primaryFunction: "Back Office - Claims",
    role: "agent",
    skillLevel: "L2",
    status: "active",
    currentTickets: 0,
  ...
  },
  {
    ...
    primaryFunction: "Strategic Leadership",
    role: "ADM",
    skillLevel: "L4",
    status: "active",
    currentTickets: 0,
  ...
  },
  {
    ...
    primaryFunction: "Training & Development",
    role: "trainer",
    skillLevel: "L3",
    status: "active",
    currentTickets: 0,
  ...
  const handleCreateAgent = () => {
    if (newAgent.name && newAgent.email && newAgent.password) {
      const agent: Agent = {
        ...
        primaryFunction: newAgent.primaryFunction,
        role: newAgent.role,
        status: "active",
        currentTickets: 0,
        expanded: false,
  ...
  return (
    <div className="container mx-auto px-4 py-6">
      ...
      <div className="border border-border rounded-lg bg-card mb-6">
        {/* Table Header */}
        <div className="grid grid-cols-[40px_1fr_1fr_1fr_150px_120px_100px_120px_120px] gap-4 px-4 py-3 border-b border-border bg-muted/30">
          <div></div>
          <div className="text-sm font-medium text-muted-foreground">Name</div>
          <div className="text-sm font-medium text-muted-foreground">Email</div>
          <div className="text-sm font-medium text-muted-foreground">Primary Function</div>
        ...
        {agents.map((agent) => (
          <div key={agent.id} className="border-b border-border last:border-b-0">
            <div className="grid grid-cols-[40px_1fr_1fr_1fr_150px_120px_100px_120px_120px] gap-4 px-4 py-3 items-center">
              <button
              ...
              <div className="text-sm text-muted-foreground">{agent.primaryFunction}</div>
              <div>
