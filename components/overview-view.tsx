...
const agents = [
  ...
  { name: "Rachel Martin", level: "L1", currentTicket: 4709691, ticketLevel: "L1", status: "In Progress" },
  { name: "Rebecca Gibson", level: "L4", currentTicket: 4709684, ticketLevel: "L2", status: "In Progress" },
