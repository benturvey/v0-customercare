...
const agents = [
  ...
  { name: "Tracey Crooke", level: "MGM", currentTicket: null, ticketLevel: null, status: "Idle" },
  { name: "Tracey Johnson", level: "L4", currentTicket: 4709709, ticketLevel: "L3", status: "In Progress" },
  { name: "Vicky Lomax", level: "MGM", currentTicket: null, ticketLevel: null, status: "Idle" },
]
