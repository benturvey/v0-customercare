...
const agents = [
  ...
  { name: "Lee Higgins", level: "L2", currentTicket: null, status: "Out of Office" },
  { name: "Lisa Yates", level: "L1", currentTicket: null, status: "Idle" },
  { name: "Lucy King", level: "L1", currentTicket: null, status: "Out of Office" },
  { name: "Lynn Forrest", level: "L1", currentTicket: null, status: "Idle" },
  { name: "Olivia Liburd", level: "L2", currentTicket: null, status: "Idle" },
  { name: "Patricia McGuire", level: "L3", currentTicket: null, status: "Out of Office" },
  ...
  { name: "Sarah Adams", level: "L2", currentTicket: null, status: "Out of Office" },
  ...
  { name: "Sue Foster", level: "L2", currentTicket: null, status: "Out of Office" },
