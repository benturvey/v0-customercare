...
const agents = [
  { name: "Aaron Doherty", currentTicket: 4709708, status: "Idle" },
  { name: "Alex Lucy", currentTicket: null, status: "Idle" },
  { name: "Andrei Costea", currentTicket: 4709707, status: "Idle" },
  { name: "Annette Davidson", currentTicket: null, status: "Idle" },
  { name: "Apryl Watson", currentTicket: 4709685, status: "Idle" },
  { name: "Arlene Griffin", currentTicket: 4709696, status: "Idle" },
  { name: "Audrey Johnson", currentTicket: 4709683, status: "Idle" },
  { name: "Ben Lund", currentTicket: null, status: "Idle" },
  { name: "Danielle Marcroft", currentTicket: 4709682, status: "Idle" },
  { name: "Francine Payne", currentTicket: null, status: "Idle" },
  { name: "George Lilliston", currentTicket: 4709706, status: "Idle" },
  { name: "Georgia Collins", currentTicket: null, status: "Idle" },
  { name: "Ibrahim Anidi", currentTicket: 4709690, status: "Idle" },
  { name: "Kimberley McCormick", currentTicket: null, status: "Idle" },
  { name: "Kirsty Doyle", currentTicket: 4709697, status: "Idle" },
  ...
  { name: "Rachel Martin", currentTicket: 4709691, status: "Idle" },
  { name: "Rebecca Gibson", currentTicket: 4709684, status: "Idle" },
  { name: "Sarah Adams", currentTicket: null, status: "Idle" },
  { name: "Sarah Tshikuna", currentTicket: 4709688, status: "Idle" },
