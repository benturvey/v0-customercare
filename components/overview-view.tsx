...
const agents = [
  ...
  { name: "Annette Davidson", level: "ADM", currentTicket: null, ticketLevel: null, status: "Idle" },
  { name: "Apryl Watson", level: "L3", currentTicket: 4709685, ticketLevel: "L2", status: "In Progress" },
  ...
  { name: "Ben Lund", level: "MGM", currentTicket: null, ticketLevel: null, status: "Idle" },
  { name: "Danielle Marcroft", level: "L3", currentTicket: 4709682, ticketLevel: "L2", status: "In Progress" },
  { name: "Francine Payne", level: "MGM", currentTicket: null, ticketLevel: null, status: "Idle" },
  { name: "George Lilliston", level: "L2", currentTicket: 4709706, ticketLevel: "L3", status: "In Progress" },
  { name: "Georgia Collins", level: "L3", currentTicket: null, ticketLevel: null, status: "Idle" },
  { name: "Ibrahim Anidi", level: "L1", currentTicket: 4709690, ticketLevel: "L2", status: "In Progress" },
  { name: "Kimberley McCormick", level: "MGM", currentTicket: null, ticketLevel: null, status: "Idle" },
