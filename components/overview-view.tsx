...
const agents = [
  ...
  { name: "Patricia McGuire", level: "L1", currentTicket: null, ticketLevel: null, status: "Idle" },
  ...
  { name: "Sarah Adams", level: "L4", currentTicket: null, ticketLevel: null, status: "Idle" },
