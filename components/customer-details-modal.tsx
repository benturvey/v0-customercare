                    ...
                    <tr key={i} className="border-b last:border-0 hover:bg-muted/20">
                      ...
                      <td className="px-2 py-4">
                        <button 
                          ...
                          onClick={() => {
                            if (row.contract === "3300" || row.contract === "3518" || row.contract === "3024907" || row.contract === "1RY011" || row.contract === "7RY071" || row.contract === "3RY031" || row.contract === "GFS900277" || row.contract === "CW7297") {
